...
public class ExampleStandModel extends HumanoidStandModel<NovemberRainEntity> {
    ...
    protected void initActionPoses() { // TODO pickaxe throwing anim
        actionAnim.put(StandPose.RANGED_ATTACK, new PosedActionAnimation.Builder<NovemberRainEntity>()
    ...
    @Override
    public void prepareMobModel(NovemberRainEntity entity, float walkAnimPos, float walkAnimSpeed, float partialTick) {
    ...
    protected ModelPose<NovemberRainEntity> initIdlePose() {
        return super.initIdlePose();
    }

    @Override
    protected IModelPose<NovemberRainEntity> initIdlePose2Loop() {
